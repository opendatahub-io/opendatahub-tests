...
from tests.model_serving.model_runtime.vllm_omni.utils import run_tts_inference
...
class TestVllmOmniTtsQwen3:
    ...
    def test_vllm_omni_no_pii_in_logs(
        ...
        predictor_pods = get_pods_by_isvc_label(client=admin_client, isvc=vllm_omni_inference_service)
        assert predictor_pods, (
            f"No predictor pods found for ISVC '{vllm_omni_inference_service.name}' "
