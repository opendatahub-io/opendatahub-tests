...
from utilities.constants import AcceleratorType, Ports, RuntimeTemplates, Timeout
...
# Probe configuration — derived from actual vllm-omni-cuda-runtime-template spec.
# The template does not set timeoutSeconds; Kubernetes defaults to 1.
# startup: max 1200 s window (40 × 30 s); no initialDelaySeconds on readiness/liveness
...
# Per-model ISVC readiness timeout (seconds)
OMNI_ISVC_TIMEOUTS: dict[str, int] = {
    QWEN3_OMNI_MODEL_PATH: 2700,
    QWEN3_TTS_MODEL_PATH: Timeout.TIMEOUT_15MIN,
    VOXTRAL_TTS_MODEL_PATH: Timeout.TIMEOUT_15MIN,
    OMNIVOICE_MODEL_PATH: Timeout.TIMEOUT_10MIN,
    FLUX2_MODEL_PATH: Timeout.TIMEOUT_20MIN,
}
