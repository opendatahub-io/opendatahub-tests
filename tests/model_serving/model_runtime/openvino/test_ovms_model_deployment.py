...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {
                **get_model_namespace_dict(
                    model_format_name=ONNX_MODEL_FORMAT_NAME,
            ...
            {
                **get_deployment_config_dict(
                    model_format_name=ONNX_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE
                )
            },
            {**get_model_storage_uri_dict(model_format_name=ONNX_MODEL_FORMAT_NAME)},
            {
                **get_deployment_config_dict(
                    model_format_name=ONNX_MODEL_FORMAT_NAME, deployment_type=RAW_DEPLOYMENT_TYPE
                )
        ...
        pytest.param(
            ...
            {
                **get_deployment_config_dict(
                    model_format_name=ONNX_MODEL_FORMAT_NAME, deployment_type=SERVERLESS_DEPLOYMENT_TYPE
                )
            },
            {**get_model_storage_uri_dict(model_format_name=ONNX_MODEL_FORMAT_NAME)},
            {
