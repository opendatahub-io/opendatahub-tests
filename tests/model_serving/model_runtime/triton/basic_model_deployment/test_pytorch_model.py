...
class TestPytorchModel:
    """
    Test class for pytorch inference using Triton on KServe.
    ...
    def test_pytorch_inference(
        ...
        """
        input_path = TRITON_GRPC_PYTORCH_INPUT_PATH if protocol == Protocols.GRPC else TRITON_REST_PYTORCH_INPUT_PATH
