...
from utilities.constants import KServeDeploymentType, Labels, Protocols, RuntimeTemplates, Timeout
...
def send_grpc_request(url: str, input_data: dict[str, Any], root_dir: str, insecure: bool = False) -> Any:
    """Uses grpcurl with inline -d for small payloads and stdin for large payloads."""
