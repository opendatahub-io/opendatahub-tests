...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {"name": ModelFormat.SKLEARN, "deployment_mode": KServeDeploymentType.RAW_DEPLOYMENT},
            {"name": "sklearn", "deployment_mode": KServeDeploymentType.RAW_DEPLOYMENT},
            id="sklearn-pvc-RawDeployment",
