...
from tests.model_serving.model_runtime.vllm.cpu.ibm_power_z.constant import (
    FALCON3_7B_INSTRUCT_MODEL_PATH,
...
class TestFalcon37BInstruct:
    """Deploy Falcon3-7B-Instruct on IBM Power or Z and verify chat completions inference."""

    def test_falcon3_7b_instruct_chat_inference(
        self,
        ...
        Given a vLLM CPU ServingRuntime and Falcon3-7B-Instruct backed by S3 storage
