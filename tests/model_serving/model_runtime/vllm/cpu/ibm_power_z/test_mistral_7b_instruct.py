...
class TestMistral7BInstruct:
    """Deploy Mistral-7B-Instruct on IBM Power or Z and verify chat completions inference."""

    def test_mistral_7b_instruct_chat_inference(
        self,
        ...
        Given a vLLM CPU ServingRuntime and Mistral-7B-Instruct backed by S3 storage
