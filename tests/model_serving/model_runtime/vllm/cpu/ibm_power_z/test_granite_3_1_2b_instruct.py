...
from tests.model_serving.model_runtime.vllm.cpu.ibm_power_z.constant import (
    GRANITE_3_1_2B_INSTRUCT_MODEL_PATH,
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {"name": "granite-3-1-2b-cpu"},
            {"model-dir": GRANITE_3_1_2B_INSTRUCT_MODEL_PATH},
...
class TestGranite312BInstruct:
    """Deploy Granite-3.1-2B-Instruct on IBM Power or Z and verify chat completions inference."""

    def test_granite_3_1_2b_instruct_chat_inference(
        self,
        ...
        Given a vLLM CPU ServingRuntime and Granite-3.1-2B-Instruct backed by S3 storage
