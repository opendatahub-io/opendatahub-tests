...
from tests.model_serving.model_runtime.vllm.cpu.ibm_power_z.constant import (
    ...
    PHI_3_MINI_4K_INSTRUCT_MODEL_PATH,
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {"model-dir": PHI_3_MINI_4K_INSTRUCT_MODEL_PATH},
...
class TestPhi3Mini4KInstruct:
    """Deploy Phi-3-mini-4k-instruct on IBM Power or Z and verify chat completions inference."""

    def test_phi_3_mini_4k_instruct_chat_inference(
        self,
        ...
        Given a vLLM CPU ServingRuntime and Phi-3-mini-4k-instruct backed by S3 storage
