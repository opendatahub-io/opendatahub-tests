...
from utilities.constants import AcceleratorType, KServeDeploymentType, Protocols
...
vLLM_CONFIG: dict[str, dict[str, Any]] = {
    "port_configurations": {
        "grpc": [{"containerPort": GRPC_PORT, "name": GRPC_PORT_NAME, "protocol": Protocols.TCP}],
        "raw": [
            {"containerPort": REST_PORT, "name": REST_PORT_NAME, "protocol": Protocols.TCP},
            {"containerPort": GRPC_PORT, "name": GRPC_PORT_NAME, "protocol": Protocols.TCP},
        ],
    },
