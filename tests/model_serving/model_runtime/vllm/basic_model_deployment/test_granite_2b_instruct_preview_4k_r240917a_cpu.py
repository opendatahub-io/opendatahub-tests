...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {"name": "granite-2b-preview-raw-cpu"},
            {"model-dir": "models/granite-2b-instruct-preview-4k-r240917a"},
...
class TestGranite2BInstructPreview4KR240917AModelCPU:
    def test_deploy_model_inference(
        ...
        model_name = "granite-2b-instruct-preview-4k-r240917a"
