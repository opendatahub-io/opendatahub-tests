...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {"name": "granite-8b-preview-raw-cpu"},
            {"model-dir": "models/granite-8b-instruct-preview-4k-r240917a"},
...
class TestGranite8BInstructPreview4KR240917AModelCPU:
    def test_deploy_model_inference(
        ...
        model_name = "granite-8b-instruct-preview-4k-r240917a"
