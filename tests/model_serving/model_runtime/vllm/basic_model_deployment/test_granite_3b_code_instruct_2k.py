...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {"name": "granite-3b-code-raw-cpu"},
            {"model-dir": "models/granite-3b-code-instruct-2k"},
...
class TestGranite3BCodeInstruct2KModelCPU:
    def test_deploy_model_inference(
        ...
        model_name = "granite-3b-code-instruct-2k"
