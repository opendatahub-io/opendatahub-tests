...
class TestAdmissionCheckPreUpgrade:
    ...
    def test_job_exists(
        ...
        LOGGER.info(
            f"[PRE-UPGRADE] PASS: Job exists, job={admission_check_job.name}",
        )
    ...
    def test_workload_quota_reserved(
        ...
        LOGGER.info(
            f"[PRE-UPGRADE] PASS: Workload has QuotaReserved=True, workload={admission_check_workload.name}",
        )
    ...
    def test_workload_not_admitted(
        ...
        LOGGER.info(
            f"[PRE-UPGRADE] PASS: Workload is gated by AdmissionCheck, workload={admission_check_workload.name}",
        )
...
class TestAdmissionCheckPostUpgrade:
    ...
    def test_admission_check_exists(
        ...
        LOGGER.info(
            f"[POST-UPGRADE] PASS: AdmissionCheck survived upgrade and is Active, "
            f"admission_check={AC_ADMISSION_CHECK_NAME}",
        )
    ...
    def test_cluster_queue_references_admission_check(
        ...
        LOGGER.info(
            f"[POST-UPGRADE] PASS: ClusterQueue strategy survived upgrade, "
            f"cluster_queue={AC_CLUSTER_QUEUE}, admission_check={AC_ADMISSION_CHECK_NAME}",
        )
    ...
    def test_job_completes_after_admission(
        ...
        LOGGER.info(
            f"[POST-UPGRADE] PASS: Job completed after admission, job={admission_check_job.name}",
        )
