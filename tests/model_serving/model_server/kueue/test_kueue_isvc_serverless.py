...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {**ONNX_SERVERLESS_INFERENCE_SERVICE_CONFIG,"name":"kueue", "min-replicas": min_replicas, "max-replicas": max_replicas, "labels": {"kueue.x-k8s.io/queue-name": local_queue_name}, "deployment-mode": KServeDeploymentType.SERVERLESS, "resources": isvc_resources},
...
class TestKueueInferenceServiceServerless:
    def test_kueue_inference_service_model_mesh(self, admin_client, kueue_cluster_queue_from_template, kueue_resource_flavor_from_template, kueue_local_queue_from_template, kueue_kserve_inference_service, kueue_kserve_serving_runtime):
