...
@pytest.mark.parametrize(
    "unprivileged_model_namespace, ogx_server_config, vector_store, dataset",
    [
        pytest.param(
...
class TestOgxVectorStores:
    ...
    def test_vector_stores_file_upload(
        ...
        completed_files = list(
            unprivileged_ogx_client.vector_stores.files.list(
    ...
    def test_vector_stores_search(
        ...
        for search_mode in search_modes:
            ...
            for record in qa_records:
                search_response = unprivileged_ogx_client.vector_stores.search(
