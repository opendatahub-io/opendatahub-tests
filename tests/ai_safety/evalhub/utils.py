...
def build_git_test_data_ref(
    ...
    git_ref: dict[str, str] = {"repository_url": repository_url, "ref": ref}
    if sub_path is not None:
...
def build_git_job_payload(
    ...
    git_ref = build_git_test_data_ref(repository_url=repository_url, ref=ref, sub_path=sub_path, secret_ref=secret_ref)
    for benchmark in payload["benchmarks"]:
