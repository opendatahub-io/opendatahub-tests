...
@pytest.fixture(scope="session")
def expected_image_registry() -> str:
    """The registry product images are expected to be served from, based on the operator distribution."""
    return get_expected_image_registry()
