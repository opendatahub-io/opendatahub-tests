...
def cluster_sanity_scope_session(
    ...
    if {"cluster_health", "operator_health", "kueue"} & selected_markers:
        LOGGER.info("Skipping cluster sanity check because selected tests include cluster/operator health or kueue")
        return
