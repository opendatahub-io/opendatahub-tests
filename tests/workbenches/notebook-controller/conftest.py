...
def patched_kueue_manager_config(
    ...
    """Patch the kueue-manager-config ConfigMap to enable pod and statefulset frameworks

    This fixture:
    1. Stores the original ConfigMap data and annotations
    2. Patches the ConfigMap with required changes
    3. Restarts kueue-controller-manager deployment to pick up changes
    4. Yields the patched ConfigMap for tests
    5. On teardown: restores original config and restarts deployment again
    """
    ...
    def restart_kueue_deployment(reason: str):
        ...
        kueue_deployment.wait_for_replicas()
