...
class TestDriftMetrics:
    ...
    def test_send_inference_request_and_verify_trustyai_service(
        self, admin_client, openshift_token, model_namespace, trustyai_service_pvc, gaussian_credit_model
    ) -> None:
        send_inference_requests_and_verify_trustyai_service(client=admin_client, token=openshift_token, data_path="./tests/trustyai/drift/model_data/data_batches", trustyai_service=trustyai_service_pvc, inference_service=gaussian_credit_model)
