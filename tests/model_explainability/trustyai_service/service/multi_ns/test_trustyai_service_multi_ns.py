...
from tests.model_explainability.trustyai_service.trustyai_service_utils import (
    ...
    verify_trustyai_service_metric_delete_request, verify_trustyai_service_metric_request,
)
...
class TestDriftMetricsWithDBStorageMultiNs:
    ...
    def test_drift_send_inference_and_verify_trustyai_service_with_db_storage(
        ...
        for tai, inference_model, inference_token in zip ( trustyai_service_with_db_storage_multi_ns, gaussian_credit_model_multi_ns, isvc_getter_token_multi_ns):
            send_inferences_and_verify_trustyai_service_registered(
                client=admin_client,
                token=current_client_token,
                data_path=f"{DRIFT_BASE_DATA_PATH}/data_batches",
