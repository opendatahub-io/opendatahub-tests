...
@pytest.mark.parametrize(
    "model_namespace, orchestrator_config, guardrails_orchestrator, llama_stack_server_config",
    [
        pytest.param(
...
class TestLlamaStackFMSGuardrailsProvider:
    ...
    def test_fms_guardrails_register_shield(
        self, current_client_token, patched_llamastack_deployment_tls_certs, llama_stack_client
    ):
        shield_params = {
            "type": "content",
