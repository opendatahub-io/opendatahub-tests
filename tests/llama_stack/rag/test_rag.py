...
class TestLlamaStackRag:
    ...
    def test_rag_inference_embeddings(
        self, minio_pod, minio_data_connection, llama_stack_client: LlamaStackClient, llama_stack_models
    ) -> None:
        """
    ...
    def test_rag_full_responses(
        ...
        _response_fn = self._create_response_function(
            client=llama_stack_client, models=llama_stack_models, vector_store=vector_store_with_docs
        )
    ...
    def test_rag_vector_store_search(
        self, minio_pod, minio_data_connection, llama_stack_client: LlamaStackClient, vector_store_with_docs
    ) -> None:
        """
