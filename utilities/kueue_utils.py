...
def get_queue_resource_usage(queue: Union[ClusterQueue, LocalQueue], flavor_name: str) -> Dict[str, Union[str, bool]]:
    """
    ...
    """
    usage_info: Dict[str, Union[str, bool]] = {"cpu": "0", "memory": "0", "found": False}
...
def verify_queue_tracks_workload(
    queue: Union[ClusterQueue, LocalQueue],
    flavor_name: str,
    ...
    Returns:
        True if the queue is tracking the workload, False otherwise
    """
