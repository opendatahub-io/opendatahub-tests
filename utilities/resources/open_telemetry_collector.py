...
class OpenTelemetryCollector(NamespacedResource):
    ...
    def __init__(
        self,
        config: dict[str, dict[str, dict[str, str | int | bool] | list[str]]] | None = None,
        ...
        **kwargs: Any,
        ...
        """
        Args:
            config (dict[str, dict[str, dict[str, str | int | bool] | list[str]]]):
                Required. Collector pipeline configuration.
            ...
            resources (dict[str, dict[str, str]]): Resource requests/limits.
        """
