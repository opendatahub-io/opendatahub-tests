        ...
        "rerank": {
            "query_input": {
                "documents": [
                    ...
                    {
                        "text": "Cooling Temperature for Nitrogen is different",
                        "more": "There are other features on Nitrogen",
                    },
                    {
                        "text": "What elements could be used Nitrogen, Helium",
                        "meta": {"date": "today", "i": 999, "f": 12.34},
                    },
                ],
                "query": "At what temperature does liquid Nitrogen boil?",
            },
            "query_output": r'{"result": \{.*\}, "producer_id": {"name": "EmbeddingModule", "version": "\d.\d.\d"}, "input_token_count": \d+}',
        },
        "sentence-similarity": {
            "query_input": {
                "source_sentence": "At what temperature does liquid Nitrogen boil?",
                "sentences": [
                    "At what temperature does liquid Nitrogen boil",
                    "Hydrogen boils and cools at temperatures",
                ],
            },
            "query_output": r'{"result": \{.*\}, "producer_id": {"name": "EmbeddingModule", "version": "\d.\d.\d"}, "input_token_count": \d+}',
        },
