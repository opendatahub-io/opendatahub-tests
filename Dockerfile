...
# pragma: allowlist secret
ARG GRPCURL_SHA256_S390X=9f0ce805df8266d4233ecd54e55d01974b0665f8fc3b4f3598fa7fd8301c5e2b
...
RUN ARCH=$(uname -m) && \
    case "${ARCH}" in \
      ...
      s390x)   GRPCURL_SHA256="${GRPCURL_SHA256_S390X}" ;; \
