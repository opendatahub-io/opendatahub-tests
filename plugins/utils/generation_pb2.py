...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    ...
    b"\x01 \x01(\t\x12\x16\n\tprefix_id\x18\x02 \x01(\tH\x00\x88\x01\x01\x12*\n\x08requests\x18\x03 \x03("
    b"\x0b\x32\x18.fmaas.GenerationRequest\x12!\n\x06params\x18\n \x01("
    b'\x0b\x32\x11.fmaas.ParametersB\x0c\n\n_prefix_id"\x9f\x01\n\x17SingleGenerationRequest\x12\x10\n\x08model_id'
    b"\x18\x01 \x01(\t\x12\x16\n\tprefix_id\x18\x02 \x01(\tH\x00\x88\x01\x01\x12)\n\x07request\x18\x03 \x01("
    b"\x0b\x32\x18.fmaas.GenerationRequest\x12!\n\x06params\x18\n \x01("
    ...
    b'\t"\xb4\x01\n\x11ModelInfoResponse\x12\x36\n\nmodel_kind\x18\x01 \x01('
    b'\x0e\x32".fmaas.ModelInfoResponse.ModelKind\x12\x1b\n\x13max_sequence_length\x18\x02 \x01('
    b"\r\x12\x16\n\x0emax_new_tokens\x18\x03 \x01("
    ...
    b"\x05\x45RROR\x10\x07\x32\xc4\x02\n\x11GenerationService\x12O\n\x08Generate\x12\x1f.fmaas"
    b'.BatchedGenerationRequest\x1a .fmaas.BatchedGenerationResponse"\x00\x12O\n\x0eGenerateStream\x12\x1e.fmaas'
    b'.SingleGenerationRequest\x1a\x19.fmaas.GenerationResponse"\x00\x30\x01\x12K\n\x08Tokenize\x12\x1d.fmaas'
    b'.BatchedTokenizeRequest\x1a\x1e.fmaas.BatchedTokenizeResponse"\x00\x12@\n\tModelInfo\x12\x17.fmaas'
    b'.ModelInfoRequest\x1a\x18.fmaas.ModelInfoResponse"\x00\x62\x06proto3'
)
